...
void wagon()
{
	...
	glBegin(GL_QUADS);
	  ...
	  glTexCoord2f(1., 0.3);	glVertex3f(35.0, 17.0, 6.0);
	  glTexCoord2f(0., 0.3);	glVertex3f(-35.0, 17.0, 6.0);
	  ...
	  glTexCoord2f(0., 0.44); glVertex3f(-35.0, 17.0, 6.0);
	  glTexCoord2f(1, 0.44); glVertex3f(35.0, 17.0,  6.0);
	  glTexCoord2f(1, 0.82); glVertex3f(35.0, 17.0, -6.0);
	  glTexCoord2f(0., 0.82); glVertex3f(-35.0, 17.0, -6.0);
	glEnd();
